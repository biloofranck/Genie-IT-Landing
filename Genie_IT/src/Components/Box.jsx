...
const Box = () => {
  return (
    <div className=" ">
      <div className="bg-gray-900 p-6 rounded-[40px]  w-full  mb-5 h-[280px] md:h-[250px] sm:h-auto">
        <p className="italic text-[50px] mt-5 ml-5  max-[590px]:text-[20px]">"</p>
        ...
        <div className="mt-4">
          <div className="flex items-center">
            ...
            <div className="ml-8 sm:ml-4">
              <p className="mt-2 font-semibold text-base sm:text-sm">
                Mark Grabbs
              </p>
